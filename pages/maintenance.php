...
<head>
	...
	<meta property="og:description" content="Website momentan im Wartungsmodus" />
	...
	html{
		height:100%;
		background: #ffffff url(https://images.unsplash.com/reserve/L55hYy77SLqb6zeTMlWr_IMG_9035.jpg?ixlib=rb-0.3.5&q=80&fm=jpg&crop=entropy&w=1080&fit=max&s=be8f13a3ec5d152f60ede73809372c97); no-repeat center bottom fixed;
...
<body>
	<div id="cspio-page">
		<div id="cspio-content">
			...
			<img id="cspio-logo" src="LOGOURL">
			    				
			<h1 id="cspio-headline">Wartungsmodus</h1>			    				
			
			<div id="cspio-description">Wir befinden uns momentan im Wartungsmodus. Bitte besuchen Sie uns in Kürze erneut.</div>			    				
